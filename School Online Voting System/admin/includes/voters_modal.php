        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_Registration_No" class="col-sm-3 control-label">Registration No.</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_Registration_No" name="Registration_No">
                    </div>
                </div>
                <div class="form-group">
